...
import com.mcl.shop.service.*;
import com.mcl.shop.util.BigDecimalUtil;
...
//                    goods.setNewPrice(goods.getPrice()*goods.getNum()* activity.getDiscount());
                    goods.setNewPrice(BigDecimalUtil.safeMultiply(goods.getPrice(),goods.getNum()* activity.getDiscount()));
...
//                        goods.setNewPrice((float) (goods.getPrice()*(goods.getNum()-activity.getReducenum())));
                        goods.setNewPrice(BigDecimalUtil.safeMultiply(goods.getPrice(),goods.getNum()-activity.getReducenum()));
                    } else {
//                        goods.setNewPrice((float) (goods.getPrice()*goods.getNum()));
                        goods.setNewPrice(BigDecimalUtil.safeMultiply(goods.getPrice(),goods.getNum()));
                    }
                } else {
//                    goods.setNewPrice((float) (goods.getPrice()*goods.getNum()));
                    goods.setNewPrice(BigDecimalUtil.safeMultiply(goods.getPrice().doubleValue(),goods.getNum()));
                }
            }else
            {
//                goods.setNewPrice(goods.getPrice()*goods.getNum()*1F);
                goods.setNewPrice(BigDecimalUtil.safeMultiply(goods.getPrice(),goods.getNum()));
            }
            totalPrice = BigDecimalUtil.safeAdd(totalPrice,goods.getNewPrice());
            oldTotalPrice = BigDecimalUtil.safeAdd(oldTotalPrice,BigDecimalUtil.safeMultiply(goods.getNum(),goods.getPrice()));
